/**
 * JavaScript Class Inheritance implementation
 * Taken from the OpenERP Web Client v7.0
 * (which was in turn based on John Resig's work)
 *
...
exports.Class.extend = function() {
    ...
    function Class() {
        if(this.constructor !== exports.Class){
